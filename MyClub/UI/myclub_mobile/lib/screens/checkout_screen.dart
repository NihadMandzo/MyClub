                        ...
                        child: ElevatedButton(
                          ...
                          child: (_isLoading || _isProcessingPayment)
                              ...
                              : Row(
                                  ...
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
                                    Icon(_selectedPaymentMethod == 'Stripe' ? Icons.payment : Icons.shopping_cart, size: 20),
                                    const SizedBox(width: 8),
                                    Flexible(
                                      child: Text(
                                        _selectedPaymentMethod == 'Stripe' 
                                          ? 'Plati sa Stripe - ${widget.cart.finalAmount.toStringAsFixed(2)} KM'
                                          : 'Kreiraj narudžbu - ${widget.cart.finalAmount.toStringAsFixed(2)} KM',
